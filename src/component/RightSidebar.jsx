...
const RightSideBar = ({ distance, dateCheckList, handleExcepUpload, setProgress }) => {
    return (
        <div>
            <Form.Item label="거리">
            ...
            <div style={{display: 'flex', gap: '10px', justifyContent: 'center', alignItems: 'center'}}>
                <UploadExcel handleExcepUpload={handleExcepUpload} setProgress={setProgress}/>
                <DownloadExcel url={'/download'} text={'모든 물품 엑셀 다운로드'} setProgress={setProgress}/>
            </div>
        </div>
    );
};
